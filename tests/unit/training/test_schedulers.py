...
def test_cosine_with_warmup_min_lr_ge_base_lr_raises() -> None:
    # min_lr >= base_lr would make the post-warmup multiplier climb
    # instead of decay; reject it rather than ship an inverted schedule.
