...
| 11 | The `/gemini-final-pass design` against requirements + architecture surfaces no new CRITICAL | For v1.0.0, Gemini was deferred per the user-ratified Claude-only consensus; this criterion is documented as "Claude-only consensus" in the CHANGELOG. |
