...
docs = [
    ...
    "numpydoc>=1.8",
    "sphinx-gallery>=0.18",
    "autodoc-pydantic>=2.2",          # pydantic v2 field-table rendering
    "sphinx-copybutton>=0.5",         # one-click copy on every snippet
    "myst-parser>=4",                 # Markdown sources alongside reST
]
```
