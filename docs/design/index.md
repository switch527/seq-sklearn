...
seq-sklearn, start with the [tutorial](../tutorial/first_classifier)
or the [how-to guides](../how-to/index).
```

These documents are the authoritative source for what the library
promises and why. They are versioned with the code, so the historical
